"""
NOTE: This is the same exercise as pandas_wind_statistics.py, except that the solution
for parts 1 and 2 are given.
...
The code provided below reads the data in a Pandas DataFrame and parses the first three
columns as a date (this corresponds to part 1 and 2 of the original exercise).
...
from pandas import read_table, Period
